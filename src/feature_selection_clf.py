"""
Summary: Feature selection for the classification problem
TODO:
"""
import pandas as pd
...
df_test.to_csv('input_data/model_data/df_validation.csv', index=False)
fs_train.df_train.to_csv('input_data/model_data/df_train.csv', index=False)
